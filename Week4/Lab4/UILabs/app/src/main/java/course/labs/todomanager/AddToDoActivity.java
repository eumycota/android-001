	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		resetButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				//TODO1 - Reset data fields to default values
                setDefaultDateTime();
                mTitleText.setText("");
		...
		submitButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
                ...
                int priorityBtnId = mPriorityRadioGroup.getCheckedRadioButtonId();
                switch (priorityBtnId) {
				...
				//TODO1 -  Get Status
				Status status = null;
                int statusBtnId = mStatusRadioGroup.getCheckedRadioButtonId();
                switch (statusBtnId) {
				...
				//TODO1 - return data Intent and finish
