...
public class ActivityOne extends Activity {
    ...
    // 1TODO: Create variables for each of the TextViews, called
    // mTvCreate, etc.
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// 1TODO: Assign the appropriate TextViews to the TextView variables
		...
		launchActivityTwoButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
                ...
                Intent secondActivity = new Intent(ActivityOne.this, ActivityTwo.class);
